...
Click on a component name (for example _MyComponent_) to display the component you want to test.
...
This creates a new instance of _FrontOffice_ state machine and affects values to _FrontOffice_ public member.
We can verify _FrontOffice_ public member affectation. Click on _Pending_ to display details in the property panel.
